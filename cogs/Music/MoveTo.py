...
class MoveTo(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @app_commands.command(name='move', description="Move the bot to a different voice channel.")
    @app_commands.describe(channel="The name of the voice channel to move to")
    @check_if_disabled()
    async def move(self, interaction: discord.Interaction, channel: str):
